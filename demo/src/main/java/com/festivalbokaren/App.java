...
public class App {
    ...
    // book ticket method
    public static void bookTicket(Scanner scanner, List<Ticket> bookedTickets) {
    ...
    public static void showBookedTickets(List<Ticket> bookedTickets) {
        ...
        for (Ticket ticket : bookedTickets) {
            System.out.println(
                    ticket.getFirstName() + " " + ticket.getLastName() + ", Birth Year: " + ticket.getBirthYear());
        }
    }

    // method for count of each ticket
    public static void showTicketCount(List<Ticket> bookedTickets) {
    ...
    public static void saveBookedTickets(List<Ticket> bookedTickets) {
    ...
    public static List<Ticket> loadBookedTickets() {
